      ...
      <>
        <div id="sidebar" className="w-full py-5 mb-10 flex flex-row justify-between px-10 bg-slate-700 shadow-xl">
          ...
          <ul className="flex justify-between py-2">
            ...
            <li>
              <Link to={``} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Configure Module</Link>
            </li>
          </ul>
          </nav>
        </div>
