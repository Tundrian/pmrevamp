    ...
    <>
      <form className="grid grid-cols-4">
        <div className="mt-3 mx-3 border-b pb-3 w-full pr-5 grid grid-cols-4 col-span-4">
          ...
          <input
            className="col-span-3 shadow appearance-none border rounded  py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline w-full border-blue-600"
            type="text"
          />
        </div>
        <div className="relative mt-3 border-b pb-3 w-full grid grid-cols-4 col-span-4">
          <label className=" block col-span-1" htmlFor="">
            Topic:{" "}
          </label>
          <select
            name=""
            id=""
            className="bg-white shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline col-span-3"
          >
        ...
        {/* <div className="mt-3 mx-3 border-b pb-3 w-full pr-5 grid grid-cols-4 col-span-4" >
                <label className="col-span-1" htmlFor="">Milestone: </label>
        ...
        <div className="mt-[1rem] flex gap-[0.5rem] justify-end">
          <button
            type="submit"
            className="bg-blue-500 text-white border border-gray-400 rounded-lg px-3 py-1 shadow-md hover:bg-green-500 mx-2"
          >
            Submit
          </button>
        </div>
